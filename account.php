...
<form autocomplete="off" method="POST" action="updateakun.php">
	...
	<table style="background-color: #ffff; margin-top: 30px; " >
     <tr>
         <td >
         	...
         	<input id = "kel" type="text" name = "name" value="<?php echo $_SESSION['name']?>" style="border: none;border-bottom: 1px solid black;outline: none;" required="" readonly></input>
	 ...
	 <tr>
         <td >
         	<span style="color:#3f51b5; font-size: 30px;float : left"></span>
         	<input id = "kel2" type="text" name = "phone" value="<?php echo $_SESSION['phone']?>" style="border: none;border-bottom: 1px solid black;outline: none;" readonly></input>
